...
flowchart TD
    ...
    subgraph T4 ["🖥️ 4. SERVING & CONSUMPTION TIER (Phục vụ & Trực quan hóa)"]
...
### 🖥️ PHẦN 4: CHI TIẾT TẦNG PHỤC VỤ VÀ LUỒNG KÉP FAST/SLOW PATH (SERVING & DUAL-PATH)
...
flowchart LR
    ...
    subgraph Serving_Outputs ["🖥️ Outputs Phục vụ"]
        WebUI["🍿 Modern Web UI (Dark Glassmorphism)"]
        Superset["📊 Apache Superset BI Dashboards"]
    end
